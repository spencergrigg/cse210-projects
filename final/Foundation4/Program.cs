...
class Program
{
    static void Main(string[] args)
    {
        ...
        Running running1 = new Running("1/1/1011", 65, 8, "Running");
        Cycling cycling1 = new Cycling("2/2/2022", 120, 18, "Cycling");
        Swimming swimming1 = new Swimming("3/3/3033", 20, 10, "Swimming");
